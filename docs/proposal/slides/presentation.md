...
- **Tic Tac Toe** (first game):
  ...
  - Win stats saved in the browser
...
- JavaScript + React + Vite — runs entirely in the browser
- Minimax algorithm powers the Expert bot
- CSS custom properties for theming
- localStorage for stats — no server, no accounts

---

## Demo

<!-- Add a live demo here when the app is ready -->

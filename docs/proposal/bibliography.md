...
* **Link:** [https://www.coolmathgames.com/](https://www.coolmathgames.com/)
...
* **Link:** [https://poki.com/](https://poki.com/)
...
* **Link:** [https://www.miniclip.com/](https://www.miniclip.com/)
...
* **Link:** [https://www.google.com/fbx?fbx=tic_tac_toe](https://www.google.com/fbx?fbx=tic_tac_toe)
...
* **Link:** [https://play.google.com/store/apps/details?id=com.optimesoftware.tictactoe.free](https://play.google.com/store/apps/details?id=com.optimesoftware.tictactoe.free)
...
* **Link:** [https://developer.mozilla.org/en-US/docs/Web/CSS](https://developer.mozilla.org/en-US/docs/Web/CSS)
...
* **Link:** [https://vitejs.dev/](https://vitejs.dev/)
...
* **Link:** [https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API)
...
* **Link:** [https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties](https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties)
* **Type of source:** Primary documentation — MDN Web Docs.
...
* **Link:** [https://en.wikipedia.org/wiki/Minimax](https://en.wikipedia.org/wiki/Minimax)
...
* **Link:** [https://developer.mozilla.org/en-US/docs/Web/HTTP](https://developer.mozilla.org/en-US/docs/Web/HTTP)
...
* **Link:** [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON)
